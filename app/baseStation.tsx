...
const BeeStationComplete: React.FC = () => {
  return (
    <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-yellow-200 overflow-x-hidden">
      ...
      {/* 2. FLOATING FILE GALLERY (Based on Image 2) */}
      <section className="py-32 px-6 relative overflow-hidden bg-white">
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          <div className="relative h-[500px] flex items-center justify-center">
            ...
            {/* Floating Files (Abstracted from Image 2) */}
      ...
      {/* 3. CLOUD VS PRIVATE SECTION (Based on Image 1) */}
      ...
      {/* 4. TECH SPECS TABLE (Final Section) */}
...
// Helper Component for the Floating Files
const FileCard = ({ icon, label, color, pos, delay }: any) => (
  <motion.div 
